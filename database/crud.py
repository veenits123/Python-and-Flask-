...
print('\n')
# Filters
puppy_sam = Puppy.query.filter_by(name='VEENIT') # Returns list
print(puppy_sam.all())
print('\n')
###########################
###### UPDATE ############
...
###### DELETE ############
#########################
second_pup = Puppy.query.get(1) #gets permanently fucked "deleted"!!
db.session.delete(second_pup)
db.session.commit()

"""database jo file me ban rakha hai usko delete
 karenge phle firr run krayenge to error nahi aayega, 
 kyunki uss "id" kaa data alreday hum 
delete kar chuke hain smajh me aayaa kya ???"""
